...
| `panneau-1.svg` … `panneau-5.svg` | photos de vos modèles de panneaux | `panneaux/index.html` |
| `photobooth-1.svg` … `photobooth-5.svg` | photos de vos modèles de photobooth | `photobooth/index.html` |
